      ...
      <form onSubmit={handleSubmit(submitPasswordForm)}>
          ...
          <div className="flex flex-col gap-5 lg:flex-row">
            <div className="relative flex flex-col gap-2 lg:w-[48%]">
              ...
              <input
                ...
                className="w-full rounded-full border border-richblack-500 bg-transparent p-3 text-white"
        ...
        <div className="flex justify-end gap-2">
          <button
            ...
            className="rounded-full border border-richblack-300 px-6 py-2 text-richblack-300"
          >
            Cancel
          </button>
