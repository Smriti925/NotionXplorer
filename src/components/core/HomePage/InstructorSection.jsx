...
const InstructorSection = () => {
  return (
    <div className="mb-20 flex flex-col items-center gap-20 lg:mb-0 lg:h-screen lg:flex-row">
      ...
      <div className="flex flex-col gap-10 lg:w-[50%]">
        ...
        <p className="w-[90%] text-justify text-[16px] font-medium text-richblack-300">
          ...
          NotionXplorer. We provide the tools and skills to teach what you love.
        </p>
